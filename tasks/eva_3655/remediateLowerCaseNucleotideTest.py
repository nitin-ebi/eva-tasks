...
class MyTestCase(unittest.TestCase):
    def test_remediate_lower_case_nucleotide(self):
        ...
        with get_mongo_connection_handle('localhost', private_config_xml_file) as mongo_conn:
            ...
            nmc_file_path = os.path.join(working_dir, "non_merged_candidates", f"{test_db_name}.txt")
            ...
            self.qc_test_result_case_id_collision_hgvs_not_present(variants_coll)
    ...
    def qc_test_result_case_id_collision_hgvs_not_present(self, variants_coll):
